...
par(mfrow=c(2,2))
with(clearDataDateTimed, plot(datetime, Global_active_power, type = "l", xlab="", ylab="Global Active Power"))
with(clearDataDateTimed, plot(datetime, Voltage, type = "l", xlab="datetime", ylab="Voltage"))
...
with(clearDataDateTimed, plot(datetime, Global_reactive_power, type = "l", xlab="datetime", ylab="Global Rective Power"))
